...
class PurchasesService {
    ...
    add_new(data, files, user_id, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.purchaseRepository.create(data, image_data, user_id, order_details_data, next);
        });
    }
    update(data, files, user_id, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // await FileManager.deleteFiles(files);
            return yield this.purchaseRepository.update(data, image_data, user_id, next);
        });
    }
    all(query) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.purchaseRepository.all(query);
        });
    }
    data_counter(query) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.purchaseRepository.data_counter(query);
        });
    }
    ...
    find_by_id(id, next) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.purchaseRepository.find_by_id(id, next);
        });
    }
}
