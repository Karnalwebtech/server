...
class CategorieService {
    ...
    create(data, files, user_id, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return yield this.categorieRepository.create(data, imageData, seo, user_id, next);
            }
            catch (error) {
    ...
    update(data, files, user_id, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const existingCategory = yield this.categorieRepository.findBYpageid(data.id, next);
                if (!existingCategory) {
                    return this.handleError("Categorie ID does not exist", next, 400);
                }
                const existingUrl = yield this.categorieRepository.findBYUrl(data.metaCanonicalUrl, existingCategory._id);
                if (existingUrl) {
                ...
                return yield this.categorieRepository.update(data, imageData, user_id, next);
            }
            catch (error) {
                next(new ErrorHandler_1.default(error.message || "Internal Server Error", 500));
            }
    ...
    findByExistUrl(url, next) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.categorieRepository.findByExistUrl(url, next);
        });
    }
    findBySlug(url, next) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.categorieRepository.findBySlug(url, next);
        });
    }
    all(query) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.categorieRepository.all(query);
        });
    }
    data_counter(query) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    findBYpageid(id, next) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.categorieRepository.findBYpageid(id, next);
        });
    }
    removeItem(id, next) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.categorieRepository.removeItem(id, next);
        });
    }
}
