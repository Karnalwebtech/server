...
class TagService {
    ...
    create(data, files, user_id, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return yield this.tagRepository.create(data, imageData, seo, user_id, next);
            }
            catch (error) {
    ...
    update(data, files, user_id, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const existingCategory = yield this.tagRepository.findBYpageid(data.id, next);
                if (!existingCategory) {
                    return this.handleError("Tag ID does not exist", next, 400);
                }
                const existingUrl = yield this.tagRepository.findBYUrl(data.metaCanonicalUrl, existingCategory._id);
                if (existingUrl) {
                ...
                return yield this.tagRepository.update(data, imageData, user_id, next);
            }
            catch (error) {
                next(new ErrorHandler_1.default(error.message || "Internal Server Error", 500));
            }
    ...
    findByUrl(url) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.tagRepository.findByUrl(url);
        });
    }
    all(query) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.tagRepository.all(query);
        });
    }
    data_counter(query) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.tagRepository.data_counter(query);
        });
    }
    find_by_id(id, next) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.tagRepository.find_by_id(id, next);
        });
    }
    findBYpageid(id, next) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.tagRepository.findBYpageid(id, next);
        });
    }
    removeItem(id, next) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.tagRepository.removeItem(id, next);
        });
    }
}
