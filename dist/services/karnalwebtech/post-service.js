...
class PostService {
    ...
    create(data, files, user_id, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return yield this.PostRepository.create(data, imageData, seo, user_id, next);
            }
            catch (error) {
    ...
    update(data, files, user_id, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const existingCategory = yield this.PostRepository.findBYpageid(data.id, next);
                if (!existingCategory) {
                    return this.handleError("post ID does not exist", next, 400);
                }
                const existingUrl = yield this.PostRepository.findBYUrl(data.metaCanonicalUrl, existingCategory._id);
                if (existingUrl) {
                ...
                return yield this.PostRepository.update(data, imageData, user_id, next);
            }
            catch (error) {
                next(new ErrorHandler_1.default(error.message || "Internal Server Error", 500));
            }
    ...
    findByUrl(url) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.PostRepository.findByUrl(url);
        });
    }
    all(query) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.PostRepository.all(query);
        });
    }
    data_counter(query) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.PostRepository.data_counter(query);
        });
    }
    find_by_id(id, next) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.PostRepository.find_by_id(id, next);
        });
    }
    findBYpageid(id, next) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.PostRepository.findBYpageid(id, next);
        });
    }
    findBYSlug(id, next) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.PostRepository.findBYSlug(id, next);
        });
    }
    removeItem(id, next) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.PostRepository.removeItem(id, next);
        });
    }
}
